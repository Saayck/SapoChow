    ...
    <div className="max-w-4xl mx-auto space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={openCreate}>
          <Plus size={16} className="mr-1.5" /> Nuevo tema
        </Button>
      </div>
      ...
      {topics?.length === 0 ? (
        <Card>
          <div className="text-center py-12 text-gray-400">
            <p className="font-medium">No hay temas aún</p>
        ...
        <div className="grid gap-3">
          {topics?.map((topic) => (
            <div
              key={topic.id}
              className="bg-white border border-gray-200 rounded-xl px-5 py-4 flex items-start justify-between hover:border-gray-300 transition-colors"
            >
              <div>
