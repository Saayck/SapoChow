  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="overflow-hidden rounded-xl border border-amber-200/80 shadow-sm">
        <table className="min-w-full divide-y divide-amber-200/60 text-sm">
          ...
          <tbody className="divide-y divide-amber-100 bg-white">
            {data.answers.map((item) => (
              <tr key={item.question_number} className="hover:bg-amber-50/50 transition-colors">
                <td className="px-4 py-2.5 text-gray-700">{item.question_number}</td>
