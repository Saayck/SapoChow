...
class ShuffleService:
    ...
    Es responsable de mezclar preguntas y alternativas de forma independiente,
    ...
    def build_version(
        self,
        version: ExamVersion,
        topic_questions: Dict[uuid.UUID, List[Question]],
        ...
        1. Opcionalmente mezcla las preguntas dentro del bloque.
        ...
        for block_num, (topic_id, questions) in enumerate(topic_questions.items(), start=1):
            ...
            for question in ordered:
                ...
                # Asignar letra A-E en el orden mezclado.
                # correct_letter = la letra asignada a la alternativa con is_correct=True.
                correct_letter = "A"
                evq_id = uuid.uuid4()
